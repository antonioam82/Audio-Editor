...
class editor():
    def __init__(self):
        ...
        Button(self.root,text="SEARCH AUDIO FILE",width=86,height=2,bg="blue",fg="white",command=self.open_file).place(x=12,y=100)
        ...
        Button(self.root,text="CHANGE DIRECTORY",width=36,height=2,bg="orange",command=self.change_dir).place(x=650,y=53)#.place(x=650,y=301)
        ...
        self.slider = Scale(self.root,length=130,bg="gray25",fg="white",from_=10, to=-10)
        self.slider.set(0)
